...
-- CreateIndex
CREATE UNIQUE INDEX "player_game_room_id_turn_index_key" ON "player"("game_room_id", "turn_index");

-- CreateIndex
CREATE UNIQUE INDEX "question_data_key" ON "question"("data");

-- CreateIndex
CREATE UNIQUE INDEX "keys_private_key" ON "keys"("private");

-- CreateIndex
CREATE UNIQUE INDEX "keys_public_key" ON "keys"("public");
...
-- AddForeignKey
ALTER TABLE "keys" ADD CONSTRAINT "keys_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES " game"("room_id") ON DELETE CASCADE ON UPDATE CASCADE;
