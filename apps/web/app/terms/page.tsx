	...
	return (
		<Container>
			<div className="prose mx-auto my-10">
				...
				<p>
					By accessing and using our game, you agree to be bound by the
					following terms and conditions (the &quot;Terms of Service&quot; or
					&quot;TOS&quot;). If you do not agree to these terms, do not use our
					game.
				</p>
				...
				<p>
					We hope that there will not be any need for disputes between us and
					our users. However, if a dispute does arise, you agree to resolve it
					with us directly and in good faith. If we are unable to resolve the
					dispute to your satisfaction, you agree to waive any right to pursue
